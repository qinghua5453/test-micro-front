<template>
  <div class="invoice">
    ...
    <el-form :inline="true" :model="searchData" ref="searchData" class="demo-form-inline device-wrapper">
      ...
      <el-form-item>
        <a class="el-button" @click="exportTable()" v-if="getPerm('dal:billsList:excel')">导出</a>
      </el-form-item>
    </el-form>
    <!--表格-->
    <div class="tab-s">
      <el-table border :data="list" ref="list" :summary-method="getSummaries" show-summary style="width: 100%" :fit="true" height="603" class="my-table">
        ...
        <el-table-column fixed="right" label="操作" width="80">
          <template slot-scope="scope">
            <el-tooltip content="结算" placement="top" effect="dark" v-if="getPerm('dal:billsList:settlement') && (scope.row.billState == 0 || scope.row.billState == 3)">
...
export default {
  ...
  methods: {
    ...
    async getList() {
      ...
      if (this.getPerm("dal:billsList:list")) {
