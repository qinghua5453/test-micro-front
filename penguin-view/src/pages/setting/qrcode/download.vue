<template>
  <el-dialog title="下载链接" :visible.sync="visible" :before-close="modalClose" :close="modalClose" width="640px" top="50px">
    <div class="bd-con">
    ...
    confirmDownload(formName) {
      this.$refs[formName].validate(valid => {
        if (valid) {
          ...
          exportExcel(Api.QRCODE_DOWNLOAD, `${this.downloadForm.doc}.xlsx`, params);
          this.modalClose();
        }
      });
    },
