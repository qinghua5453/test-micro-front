  ...
  <div class="invoice">
    ...
    <div class="tab-s">
      <el-table border :data="list" ref="list" style="width: 100%" :fit="true" height="603" class="my-table">
        ...
        <el-table-column prop="availableStartTime" label="招标开始时间" width="130" show-overflow-tooltip></el-table-column>
        <el-table-column prop="availableEndTime" label="招标结束时间" width="130" show-overflow-tooltip></el-table-column>
        ...
        <el-table-column prop="reviewName" label="审核人" width="100" show-overflow-tooltip></el-table-column>
        <el-table-column prop="status" label="状态" width="80" show-overflow-tooltip :formatter="formatterStatusType"></el-table-column>
