<template>
    ...
    <div class="tab-s"> 
        ...
        <el-table :data="list" border tooltip-effect="dark" center="true" class="my-table" height="500">
            ...
            <el-table-column label="中奖内容" prop="value" show-overflow-tooltip :formatter="formatterContent">
            </el-table-column>
            <el-table-column label="中奖时间" prop="createTime" show-overflow-tooltip >
            </el-table-column>
    ...
    exportTable() {
      this.$refs.searchData.validate(valid => {
        if (valid) {
          ...
          exportExcel(Api.MEMBER_ASSOC_ExCEL, "中奖用户列表总览.xlsx", query);
        }
      });
    }
  },
